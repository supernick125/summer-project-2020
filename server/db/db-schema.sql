...
CREATE TABLE account_meeting (
  id integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, --************* CREATE PRIMARY KEY???? *****************
  account_id integer NOT NULL,
...
--
-- Name: newsletter_account; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: newsletter_account_pkey; Type: PK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY newsletter_account
  ADD CONSTRAINT newsletter_account_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY newsletter_account
  ADD CONSTRAINT newsletter_account_school_id_fkey FOREIGN KEY (school_id) REFERENCES school(id) ON UPDATE CASCADE ON DELETE RESTRICT;

--
-- Name: newsletter_account_account_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY newsletter_account
  ADD CONSTRAINT newsletter_account_account_type_id_fkey FOREIGN KEY (account_type_id) REFERENCES account_type(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: last_updates; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER last_updated
  BEFORE UPDATE ON newsletter_account
  FOR EACH ROW
  EXECUTE PROCEDURE last_updated();
